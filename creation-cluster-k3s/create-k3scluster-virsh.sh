...
sudo k3sup install --user multipass  --ip  $ipmaster --ssh-key  /var/snap/multipass/common/data/multipassd/ssh-keys/id_rsa
for ipadr in $ipadr ; do sudo k3sup join --user multipass  --ip  $ipadr --server-ip  $ipmaster --ssh-key /var/snap/multipass/common/data/multipassd/ssh-keys/id_rsa  ; done
